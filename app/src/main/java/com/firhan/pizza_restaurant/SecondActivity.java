...
public class SecondActivity extends AppCompatActivity {
    ...
    TextView store_name;
    String tsm = "Trans Super Mall";
    String bip = "Bandung Indah Plaza";
    String bec = "Bandung Electronic Center";
    Uri gmmIntentUri;
    Group location_maps;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Objects.equals(receiver_store_name, tsm)) {
        ...
        } else if (Objects.equals(receiver_store_name, bec)) {
